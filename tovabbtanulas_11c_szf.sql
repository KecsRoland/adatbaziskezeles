...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 24. 11:49
...
CREATE TABLE `kozepiskola` (
  `id_kozepiskola` tinyint(4) UNSIGNED NOT NULL,
  `kozopsikola_neve` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
...
INSERT INTO `kozepiskola` (`id_kozepiskola`, `kozopsikola_neve`, `kozepiskola_cime`) VALUES
...
ALTER TABLE `tanulo`
  ...
  ADD KEY `id_tanulo` (`id_tanulo`),
  ADD KEY `id_tanulo_2` (`id_tanulo`),
  ADD KEY `id_tanulo_3` (`id_tanulo`),
...
--
ALTER TABLE `kozepiskola`
  MODIFY `id_kozepiskola` tinyint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `jelentkezes`
  ...
  ADD CONSTRAINT `jelentkezes_ibfk_3` FOREIGN KEY (`tanulo_id`) REFERENCES `tanulo` (`id_tanulo`);
