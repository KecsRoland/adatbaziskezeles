...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Nov 14. 12:20
...
--
-- Tábla szerkezet ehhez a táblához `altalanas_iskola`
--

CREATE TABLE `altalanas_iskola` (
...
--
-- A tábla adatainak kiíratása `altalanas_iskola`
--

INSERT INTO `altalanas_iskola` (`id_altalanos_iskola`, `altalanos_iskola_neve`, `altalanos_iskola_cime`) VALUES
...
--
-- A tábla indexei `altalanas_iskola`
--
ALTER TABLE `altalanas_iskola`
  ADD PRIMARY KEY (`id_altalanos_iskola`),
  ADD KEY `altalanos_iskola_neve` (`altalanos_iskola_neve`),
  ADD KEY `altalanos_iskola_cime` (`altalanos_iskola_cime`);
...
ALTER TABLE `kozepiskola`
  ...
  ADD KEY `kozepiskola_neve` (`kozepiskola_neve`),
...
--
-- AUTO_INCREMENT a táblához `altalanas_iskola`
--
ALTER TABLE `altalanas_iskola`
